...
public class Test {
	...
	// we need to tell the container- to enable pre-destruction cook before the
	// container gets destroyed
	// we should invoke the destroyed method
	// we need abstract parent class

	public static void main(String[] args) {
		context = new ClassPathXmlApplicationContext("com/test1/spring/springcore/lc/annotations/config.xml");
		...
		// before container is shutdown, it needs to use Hook to invoke the destroy
		// methods
		// library for single bean annotation activate class
